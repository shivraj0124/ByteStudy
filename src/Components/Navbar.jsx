...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto mt-0 px-4 text-black'>
            <h1 className='w-full text-3xl font-bold text-gray-700 underline underline-offset-2 decoration-wavy decoration-yellow-400'>ByteStudy</h1>
            <ul className='hidden md:flex'>
                <li className='p-4 hover:underline hover:underline-offset-4 decoration-yellow-400 cursor-pointer'>Home</li>
                <li className='p-4 hover:underline hover:underline-offset-4 decoration-yellow-400 cursor-pointer'>About</li>
                <li className='p-4 hover:underline hover:underline-offset-4 decoration-yellow-400 cursor-pointer'>Contact</li>
                <li className='p-4 hover:underline hover:underline-offset-4 decoration-yellow-400 cursor-pointer'>Login</li>
